...
Write-Host -ForegroundColor Green "Build a zip for terraform to upload as the lambda function from the code in LambdaFunction/*"
Compress-Archive -Path "$PSScriptRoot/LambdaFunction/*" -DestinationPath "$PSScriptRoot/artifacts/pwsh_lambda_function_payload.zip"
